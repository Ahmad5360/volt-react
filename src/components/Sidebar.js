...
import AyroSmallLogo from "../assets/img/technologies/ayro-favicon.png";
    ...
    <>
      <Navbar expand={false} collapseOnSelect variant="dark" className="navbar-theme-primary px-4 d-md-none">
        <Navbar.Brand className="me-lg-5" as={Link} to={Routes.DashboardOverview.path}>
          <Image src={AyroSmallLogo} className="navbar-brand-light" />
        </Navbar.Brand>
        ...
        <SimpleBar className={`collapse ${showClass} sidebar d-md-block bg-primary text-white`}>
          <div className="sidebar-inner px-4 pt-3">
            ...
            <Nav className="flex-column pt-3 pt-md-0">
              <NavItem title="Ayro" link={Routes.Presentation.path} image={AyroSmallLogo} />

              <NavItem title="App" link={Routes.DashboardOverview.path} icon={faChartPie} />
